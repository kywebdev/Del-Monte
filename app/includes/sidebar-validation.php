<aside class="sidebar">
    <header class="sidebar__header">
        <div class="sidebar__top">
            <div class="sidebar__login">
                ...
                <a href="" class="sidebar__login__sitemap sitemap-toggle">
                    <div class="con">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href=""><span class="line"></span><span class="subnav-text">On-The-Go</span></a>
                            </li>
                        </ul>
                    </li>
                    <li>
        ...
        <div class="sidebar__bottom">
            ...
            <div class="flyout-newsletter">
                <form>
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-6 validation-error">
    ...
    <footer class="sidebar__footer">
        <ul>
            ...
            <li>
                <a href="" class="sitemap-toggle">Sitemap</a>
            </li>
        </ul>
