...
<html class="no-js mm-wrapper_sidebar-closed" lang="en">
    <head>
        <title>CSR Page Template | Del Monte Fresh Produce</title>
                ...
                <main class="bg-texture-lettuce">
                    <section class="main-content-wrapper">
                        ...
                        <div class="campaign-hero rip-1">
                            <picture>
                                <source srcset="img/csr-hero-desktop.jpg" media="(min-width: 901px)">
                                <img src="img/csr-hero-mobile.jpg" alt="" />
                            </picture>
                        </div>
                        <h1>CSR Page Template</h1>
