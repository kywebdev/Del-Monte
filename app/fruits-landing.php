...
<html class="no-js mm-wrapper_sidebar-closed" lang="en">
    <head>
        <title>Fruits Landing Page | Del Monte Fresh Produce</title>
                        ...
                        <nav class="breadcrumb__nav" aria-label="breadcrumb">
                            <div class="section-container">
                                <ol class="breadcrumb__list">
                                    ...
                                    <li class="breadcrumb__list-item --active" aria-current="page">Fresh Fruits</li>
                                </ol>
                            </div>
                        </nav>
                        <div class="section-container">
                            <div class="section__header">
                                <div class="section__header-container">
                                    <div class="page__title-container">
                                        <h1 class="page__title --yellow"><span>fReSh fRuitS</span></h1>
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="card">
                                            <a href="product-detail.php" class="card__img">
                                                <img src="img/pineapples.jpg" alt=""/>
